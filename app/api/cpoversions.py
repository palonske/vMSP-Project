...
async def get_available_versions(request: Request):
    ...
    return {
        ...
        "data": [
            {"version": version, "url": f"{base}/ocpi/cpo/{version}"}
            ...
            "endpoints": [
                {
                    ...
                    "url": f"{base}/ocpi/cpo/{version}/credentials"
                },
                {
                    "identifier": "locations",
                    "url": f"{base}/ocpi/cpo/{version}/locations"
                },
                {
                    "identifier": "tariffs",
                    "url": f"{base}/ocpi/cpo/{version}/tariffs"
                }
            ]
        }
    }